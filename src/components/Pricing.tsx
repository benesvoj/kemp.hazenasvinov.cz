          ...
          <Stack>
            <VStack spacing={2} textAlign='center'>
              ...
              <Text fontSize='lg' color={'gray.500'}>
                Svinovský kemp je pořádán pod hlavičkou oddílu TJ Sokol Svinov, celostátní
                soustředění pod komisi mládeže Svazu národní házené. <br />
                Na obou turnusech má vždy oddíl TJ Sokol Svinov své zástupce a to jak z řad
                vedoucích, tak zúčastněných.
              </Text>
            </VStack>
            <Stack
